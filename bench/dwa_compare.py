...
# The two loaders live in baselines_py.py: the live-simulator race imports them
# from a process that has the real rclpy, and reaching them through this module
# would pull in rig.py, whose job is stubbing it.
from bench.baselines_py import (                                  # noqa: E402
    PR_URL, PR_CACHE, KM_URL, KM_CFG_URL, KM_CACHE, KM_CFG_CACHE,
    load_reference, load_kmilo)
